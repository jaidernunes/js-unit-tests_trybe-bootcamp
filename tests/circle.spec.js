...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Verifica se retorna uma função', () => {
  ...
  it('Verifica se afunção retorna uma `key` com `value` igual à circunferência correta para um círculo de raio 2', () => {
  ...
  it('Verifica se afunção retorna uma `key` com `value` igual à área correta para um círculo de raio 3', () => {
    ...
    it('Verifica se a função retorna os valores corretos para círculo de raio 3', () => {
